<template>
  <v-container class="ma-5">
    <v-row>
      <p class="ma-5">Upload my videos and music</p>
      <v-col>
        <Dialog :title="title.music" :isMusic="(isMusic = true)" class="ma-5" />
        <Dialog
          :title="title.video"
    ...
    <v-divider borderWidth="20" class="mx-0 grey"></v-divider>
    <v-row>
      <p class="ma-5">Present my videos</p>
      <v-card
